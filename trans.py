...
if __name__ == '__main__':
    VOC2Yolo(
        class_num={'nomask': 0, 'mask': 1},  # 标签种类
        voc_img_path=r'F:\原G盘\读研课件\模式识别\yolov5-mask-42-master\yolov5-mask-42-master\score\MaskDatasets\datasets\train\JPEGImages', # 数据集图片文件夹存储路径
        voc_xml_path=r'F:\原G盘\读研课件\模式识别\yolov5-mask-42-master\yolov5-mask-42-master\score\MaskDatasets\datasets\train\Annotations', # 标签xml文件夹存储路径
        yolo_txt_save_path=r'F:\原G盘\读研课件\模式识别\yolov5-mask-42-master\yolov5-mask-42-master\score\MaskDatasets\datasets\train\txt' # 将要生成的txt文件夹存储路径
    )
